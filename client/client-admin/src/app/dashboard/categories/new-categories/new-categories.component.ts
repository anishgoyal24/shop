...
export class NewCategoriesComponent implements OnInit {
  ...
  async createNewCategory() {
    if(this.categoryName!=null && this.categoryName!='' && this.categoryDescription!=null && this.categoryDescription != ''){
      try {
      ...
      this.utilityService.warningNotification('Please fill up all the fields!')
    }
