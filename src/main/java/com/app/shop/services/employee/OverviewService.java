...
public class OverviewService {
    ...
    public HashMap<String, Object> getOrdersOverview(int month, int year) {
        ...
        List<OrderHeader> orders = employeeOrderRepository.findAllByOrderDate_MonthAndOrderDate_Year(month, year);
    ...
    public HashMap<String, Object> getOrdersCount(int month, int year) {
        returnObject = new HashMap<>();
        int count = employeeOrderRepository.findAllByOrderDate_MonthAndOrderDate_Year(month, year).size();
