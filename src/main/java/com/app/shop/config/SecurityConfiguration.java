...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.cors().and()
            .csrf().disable()
            .authorizeRequests()
            .antMatchers("/user/authenticate").permitAll().antMatchers("/customer/new/**", "/verify/**", "/assets/**", "/images/**").permitAll().antMatchers("/customer/otp").permitAll().antMatchers("/customer/forgotpassword").permitAll()
